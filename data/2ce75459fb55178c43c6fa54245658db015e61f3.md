...
- Name: 2 GIVEN the landing screen WHEN the user filters by Z - A THEN the list should order correctly
- Location: /__w/spriteCloudAssessment/spriteCloudAssessment/tests/ui_tests.spec.ts:42:5
...
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
Call log:
  - <launching> /ms-playwright/firefox-1482/firefox/firefox -no-remote -headless -profile /tmp/playwright_firefoxdev_profile-bUql0P -juggler-pipe -silent
  - <launched> pid=584
  - [pid=584][err] Running Nightly as root in a regular user's session is not supported.  ($HOME is /github/home which is owned by pwuser.)
  - [pid=584] <process did exit: exitCode=1, signal=null>
  - [pid=584] starting temporary directories cleanup
